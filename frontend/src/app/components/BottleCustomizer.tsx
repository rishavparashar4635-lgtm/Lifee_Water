...
import { Upload, Sparkles, Building2, Cake, Heart } from "lucide-react";
...
const occasions = [
  {
    ...
    // Real wedding scene background
    backgroundImage: "https://images.unsplash.com/photo-1761574044344-394d47e1a96c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwd2VkZGluZyUyMGNlcmVtb255JTIwYnJpZGUlMjBncm9vbXxlbnwxfHx8fDE3NzM3NzkzNDR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    // Realistic bottle image
    bottleImage: "https://images.unsplash.com/photo-1760043186309-69c11f4c08ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVtaXVtJTIwd2F0ZXIlMjBib3R0bGUlMjBzdHVkaW8lMjBsaWdodGluZ3xlbnwxfHx8fDE3NzM3NzkzNDN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    backgroundImage: "https://images.unsplash.com/photo-1758630737900-a28682c5aa69?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBvZmZpY2UlMjBjb3Jwb3JhdGUlMjBidXNpbmVzcyUyMHdvcmtzcGFjZXxlbnwxfHx8fDE3NzM3NzkzNDV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    bottleImage: "https://images.unsplash.com/photo-1616118132534-381148898bb4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWFsaXN0aWMlMjBwbGFzdGljJTIwd2F0ZXIlMjBib3R0bGUlMjBwcm9kdWN0JTIwcGhvdG9ncmFwaHl8ZW58MXx8fHwxNzczNzc5MzQzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  },
  {
    ...
    backgroundImage: "https://images.unsplash.com/photo-1721804812395-12c7c963ca52?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiaXJ0aGRheSUyMHBhcnR5JTIwY2VsZWJyYXRpb24lMjBjb2xvcmZ1bHxlbnwxfHx8fDE3NzM2ODA5NzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    bottleImage: "https://images.unsplash.com/photo-1670201202862-96b9c3d11375?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWFsaXN0aWMlMjB3YXRlciUyMGJvdHRsZSUyMHRyYW5zcGFyZW50JTIwcGxhc3RpYyUyMGNvbmRlbnNhdGlvbnxlbnwxfHx8fDE3NzM3NzkzNDJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
                ...
                >
                  <div className="relative h-full rounded-3xl overflow-hidden bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/10 hover:border-white/30 transition-all duration-500">
                    ...
                    <div className="relative h-80 overflow-hidden">
                      ...
                      {/* Realistic bottle integrated in foreground with proper perspective */}
                      <div className="absolute inset-0 flex items-end justify-center pb-8">
                        ...
                        >
                          ...
                          <div className="relative w-32 h-48">
                            <img
                              src={occasion.bottleImage}
                              alt={`${occasion.title} bottle`}
                              className="w-full h-full object-contain"
                            />
                            
                            {/* Custom label overlay - properly positioned */}
                            <div 
                              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-24 rounded-lg flex flex-col items-center justify-center text-center px-2"
                              style={{
                            ...
                            >
                              ...
                              <div 
                                className="text-[6px] mt-1 opacity-80"
                                style={{ color: occasion.colors.text }}
                              >
                                {occasion.labelSubtext}
                              </div>
                            </div>

                            {/* Realistic lighting reflection */}
                            <div 
                              className="absolute top-4 left-4 w-6 h-16 opacity-40 blur-sm"
                              style={{
                    ...
                    <div className="p-6 space-y-4">
                      <div className="flex items-center gap-3">
                        <div 
                          ...
                          style={{ 
                            backgroundColor: `${occasion.colors.primary}20`,
                          }}
                        >
                    ...
                    <motion.div
                      ...
                      style={{
                        background: `radial-gradient(circle at 50% 50%, ${occasion.colors.primary}20, transparent 70%)`,
                      }}
                    />
                  </div>
                </motion.div>
                  ...
                  <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-white/5 to-white/5 backdrop-blur-lg border border-white/10 p-12 flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center">
                      <p className="text-cyan-100/60 text-sm">
                        Drag to rotate • Changes update in real-time
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-3xl bg-white/10 backdrop-blur-lg border border-white/20 space-y-6">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <span className="text-white">
                          {customData.image ? "Change Image" : "Upload High-Res Photo"}
                        </span>
                      </label>
                    </div>
                    {customData.image && (
                      <img src={customData.image} alt="Preview" className="w-24 h-24 object-cover rounded-lg" />
                    )}
                  </div>
                      ...
                      {(["matte", "glossy"] as const).map((finish) => (
                        ...
                        >
                          ...
                          <div className="text-xs text-cyan-100/60 mt-1">
                            {finish === "matte" ? "Soft, elegant look" : "Shiny, premium feel"}
                          </div>
                        </motion.button>
                      ))}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setCustomData({ ...customData, quantity: parseInt(e.target.value) })}
                          min="25"
                          className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white focus:outline-none focus:border-cyan-400 transition-all"
                        />
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4">
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="py-4 px-6 rounded-xl bg-white/10 border border-white/20 text-white font-semibold hover:bg-white/20 transition-all"
                    >
                      Get Preview Quote
                    </motion.button>
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="py-4 px-6 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold shadow-lg shadow-cyan-500/50 hover:shadow-cyan-500/70 transition-all"
                    >
...
// Realistic Custom Bottle Component
    ...
    >
      ...
      >
        ...
        <g>
          ...
          <ellipse cx="97" cy="35" rx="15" ry="6" fill="rgba(255, 255, 255, 0.4)" />
        </g>

        {/* Bottle neck */}
        <path
          d="M 80 65 L 70 85 L 70 115 L 150 115 L 150 85 L 140 65 Z"
          fill="url(#customBottleGlass)"
        ...
        <g>
          <rect
            ...
            height="140"
            rx="8"
            fill="url(#customLabel)"
            opacity={finish === "glossy" ? "0.95" : "0.85"}
          />
        ...
        <ellipse
          cx="78"
          cy="180"
          rx={finish === "glossy" ? "15" : "10"}
          ry={finish === "glossy" ? "100" : "70"}
          fill="url(#customShine)"
          opacity={finish === "glossy" ? "0.7" : "0.4"}
        />
